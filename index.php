 ...
 -->
		...
		<div class="portfolio__item portfolio__item--intermezzo">
				<div class="portfolio__text">	
					...
					<h5 class="portfolio__subtitle">Shaping the Future of Mobility and Technology</h5>
					<p class="portfolio__tag">UX/UI Design</p>
					<a href="#" class="portfolio__btn">View Case Study</a>
				</div>
				<p class="portfolio__number">01</p>	
				<img class="portfolio__item__img portfolio__item__img--intermezzo01" src="img/homepage/intermezzo-1.png" alt="Intermezzo - Adagio">
				<img class="portfolio__item__img portfolio__item__img--intermezzo02" src="img/homepage/intermezzo-2.png" alt="Intermezzo - Shoe Sensor">
		</div>
		...
		<div class="portfolio__item portfolio__item--teamup">
			<div class="portfolio__text">
				...
				<p class="portfolio__subtitle">Build Better Habits Together</p>
				<p class="portfolio__tag">UX/UI Design</p>
				<a href="#" class="portfolio__btn">View Case Study</a>
			</div>
		...
		<div class="portfolio__item portfolio__item--cpy">
			<div class="portfolio__text">
				...
				<p class="portfolio__subtitle">User Experience + User Interface Redesign</p>
				<p class="portfolio__tag">UX/UI Design</p>
				<a href="#" class="portfolio__btn">View Case Study</a>
			</div>
		...
		<div class="portfolio__item portfolio__item--wildtracker">
			<div class="portfolio__text">
				...
				<p class="portfolio__subtitle">Track and Record Wildlife </p>
				<p class="portfolio__tag">Mobile App Design and Development</p>
				<a href="#" class="portfolio__btn">View Case Study</a>
			</div>
			<p class="portfolio__number">04</p>
			<img class="portfolio__item__img portfolio__item__img--wildtracker" src="img/homepage/wildtracker.png" alt="CorePower Yoga mobile app mockup">	
		</div>
		...
		<div class="portfolio__item portfolio__item--johnny">
			<div class="portfolio__text">
				...
				<p class="portfolio__subtitle">Online Wood Craft Store</p>
				<p class="portfolio__tag">Responsive Web Design and Development</p>
				<a href="#" class="portfolio__btn">View Case Study</a>
			</div>
			<p class="portfolio__number">05</p>
			<img class="portfolio__item__img portfolio__item__img--johnny" src="img/homepage/johnny.png" alt="CorePower Yoga mobile app mockup">	
		</div>
		...
		<div class="portfolio__item portfolio__item--laboheme">
			<div class="portfolio__text">
				...
				<p class="portfolio__subtitle">Rebranding a French restaurant</p>
				<p class="portfolio__tag">UI/UX Design, Graphic Design</p>
				<a href="#" class="portfolio__btn">View Case Study</a>
			</div>
			<p class="portfolio__number">06</p>
			<img class="portfolio__item__img portfolio__item__img--laboheme" src="img/homepage/la boheme.png" alt="CorePower Yoga mobile app mockup">	
		</div>
	</section>
