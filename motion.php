...
<div class="casestudy-container">
	<div class="casestudy__landingpage casestudy-landingpage--wildtracker">
			...
			<section class="casestudy__hero">
				<div class="hero__item hero__item--motion">
					<div class="hero__text">	
						<h1 class="portfolio__title hero__title">Motion Graphics</h1>
						<h4 class="hero__subtitle">A collection of my motion graphic works</h4>
					</div>
				</div>
			</section>
	</div>
...
<!-- Interaction Design -->
	<section class="casestudy__section white">
		<div class="title-group">
			...
			<h4 class="overline">Concpet Video</h4>
			<h3 class="title">TeamUp</h3>
		</div>
